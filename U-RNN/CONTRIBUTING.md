...
| Type | How |
|---|---|
| **Bug report** | [Open a Bug Report issue](code/.github/ISSUE_TEMPLATE/bug_report.yml) |
| **Feature request** | [Open a Feature Request issue](code/.github/ISSUE_TEMPLATE/feature_request.yml) |
| **Code contribution** | Fork → branch → PR (see below) |
| **New dataset** | Add YAML config + event lists + conversion script in `tools/` |
| **Documentation** | Edit `README.md` / `README_CN.md` or the tutorials under `tutorials/` |
...
4. Add the dataset to the table in `tutorials/en/02-datasets.md` (and the 中文 mirror `tutorials/zh/02-datasets.md`)

---

## Questions?

Open a [Feature Request / Question issue](code/.github/ISSUE_TEMPLATE/feature_request.yml) — we respond to all inquiries.
